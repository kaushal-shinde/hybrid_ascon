...
for label in ascon hybrid_r64 tinyjambu xoodyak giftcofb grain sparkle elephant isap photonbeetle romulus; do
...
for f in ascon hybrid_r64 tinyjambu xoodyak giftcofb grain sparkle elephant isap photonbeetle romulus; do
