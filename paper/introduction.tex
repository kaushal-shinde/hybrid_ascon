...
the benchmarking of the NIST LWC candidates. Section~\ref{sec:background}
reviews the Ascon mode and SIPROUND and states the question their opposing
cost profiles raise. Section~\ref{sec:architecture} specifies the
construction and its hardware realization. Section~\ref{sec:impl} describes the hardware and software
